...
#define YGGDRASIL_PYGIL_ALLOW_THREADS_BEGIN_GLOBAL
#define YGGDRASIL_PYGIL_ALLOW_THREADS_END_GLOBAL
// #define YGGDRASIL_PYGIL_ALLOW_THREADS_BEGIN_GLOBAL rapidjson::global_PyThreadState();
// #define YGGDRASIL_PYGIL_ALLOW_THREADS_END_GLOBAL rapidjson::global_PyThreadState(true);
